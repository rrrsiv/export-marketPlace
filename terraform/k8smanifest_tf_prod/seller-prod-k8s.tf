      ...
      template:
        ...
        spec:
          ...
          - name: emp-seller-service
            ...
            image: 453708032754.dkr.ecr.ap-south-1.amazonaws.com/emp-seller-service:a41c1f620230601131250
            ports:
            - containerPort: 8080
            resources:
              limits:
...
resource "kubectl_manifest" "config_seller" {
  yaml_body = <<-YAML
    ...
    data:
      ...
      spring.datasource.url: jdbc:mysql://emp-prod-mysql-rds.c1ebqe1npo60.ap-south-1.rds.amazonaws.com:3306/seller?createDatabaseIfNotExist=true
