      ...
      template:
        ...
        spec:
          ...
          - name: emp-buyer-service
            ...
            image: 656600766668.dkr.ecr.ap-south-1.amazonaws.com/emp-buyer-service:0c4281320230522085754
            ports:
            - containerPort: 8087
            resources:
              limits:
...
resource "kubectl_manifest" "config_buyer" {
  yaml_body = <<-YAML
    ...
    data:
      ...
      spring.datasource.url: jdbc:mysql://emp-uat-rds-mysql.chaqp2ysfjmh.ap-south-1.rds.amazonaws.com:3306/buyer?createDatabaseIfNotExist=true
