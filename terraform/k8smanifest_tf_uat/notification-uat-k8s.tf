      ...
      template:
        ...
        spec:
          ...
          - name: emp-notification-service
            ...
            image: 656600766668.dkr.ecr.ap-south-1.amazonaws.com/emp-notification-service:372cffd20230522085846
            ports:
            - containerPort: 8085
            resources:
              limits:
...
resource "kubectl_manifest" "config_notification" {
  yaml_body = <<-YAML
    ...
    data:
        ...
        spring.datasource.url: jdbc:mysql://emp-uat-rds-mysql.chaqp2ysfjmh.ap-south-1.rds.amazonaws.com:3306/notification?createDatabaseIfNotExist=true
