...
resource "kubectl_manifest" "config_payment" {
  yaml_body = <<-YAML
    ...
    data:
      ...
      spring.datasource.url: jdbc:mysql://emp-uat-rds-mysql.chaqp2ysfjmh.ap-south-1.rds.amazonaws.com:3306/payment?createDatabaseIfNotExist=true
      ...
      emp.notification.email.topic: emp.notification.email.uat
